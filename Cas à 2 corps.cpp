...
int main() {
    ...
    for (int i = 0; i < numSteps; ++i) {
        ...
        grav  << (i*dt)/86400<< "\t" << G* europa.mass * ganymede.mass / (distance(europa,ganymede)*distance(europa,ganymede))<< endl;
        grav  << (i*dt)/86400<< "\t" << G* europa.mass * io.mass / (distance(europa,io)*distance(europa,io))<< endl;
        grav  << (i*dt)/86400<< "\t" << G* io.mass * ganymede.mass / (distance(io,ganymede)*distance(io,ganymede))<< endl;
