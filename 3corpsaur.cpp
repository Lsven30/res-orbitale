...
double T;
double a;
double G = 6.6743*pow(10, -11); //introduction de la constante gravitationelle
...
void gravitationalForce(Body& body1, Body& body2, double& fx, double& fy, double& fz) {
    ...
    fx = force * (body2.x - body1.x) / r; //projection du vecteur force selons les composantes cartésiennes
...
int main() {
    ...
    for (int i = 0; i < numSteps; ++i) {
        ...
        //appel de la fonction qui calcule l'intéraction gravitationelle entre deux corps x et y en prenant les composantes de la force de y sur x
        ...
        // injection dans un fichier texte la norme de la force entre deux corps en utilisant la formule de l'interaction gravitationnelle universelle
        ...
        // Afficher les positions pour chaque step
            ...
            //Entrée des positions des différents satellites galliléens dans un fichier texte 
    ...
    //fermeture des fichiers textes ouverts
    PosIo.close();
    PosEurope.close();
    PosGanymede.close();
    gravio.close();
